...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icLogin.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, LoginActivity.class)));
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            else if (itemId == R.id.nav_more) selectedFragment = new HomeFragment();
